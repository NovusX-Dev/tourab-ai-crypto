...
$serverOut = Join-Path $root "logs\btc-policy-auto-30m-tight-exit-server-$timestamp.out.log"
$serverErr = Join-Path $root "logs\btc-policy-auto-30m-tight-exit-server-$timestamp.err.log"
$runOut = Join-Path $root "logs\btc-policy-auto-30m-tight-exit-progress-$timestamp.out.log"
$runErr = Join-Path $root "logs\btc-policy-auto-30m-tight-exit-progress-$timestamp.err.log"

$env:TOURAB_WORKER_SYMBOLS = "BTC-USDT"
$env:TOURAB_WORKER_SYMBOL_OVERRIDES_JSON = '{"BTC-USDT":{"side":"sell"}}'
$env:TOURAB_WORKER_INTERVAL_MS = "5000"
$env:TOURAB_WORKER_MAX_NOTIONAL_USD = "5"
$env:TOURAB_WORKER_STOP_DISTANCE_BPS = "20"
$env:TOURAB_WORKER_DEFAULT_SIDE = "sell"
$env:TOURAB_WORKER_SIGNAL_LOOKBACK_SEC = "180"
$env:TOURAB_WORKER_SIGNAL_SHORT_LOOKBACK_SEC = "45"
$env:TOURAB_WORKER_SIGNAL_MIN_MOVE_BPS = "18"
$env:TOURAB_WORKER_SIGNAL_MIN_ABSOLUTE_MOVE_BPS = "6"
$env:TOURAB_WORKER_SIGNAL_TREND_VOLATILITY_THRESHOLD_MULTIPLIER = "3"
$env:TOURAB_WORKER_SIGNAL_MIN_VOLATILITY_BPS = "2.5"
$env:TOURAB_WORKER_SIGNAL_ROUND_TRIP_FEE_BPS = "16"
$env:TOURAB_WORKER_QUIET_REGIME_TREND_EFFICIENCY_MIN = "5"
$env:TOURAB_WORKER_QUIET_REGIME_MOVE_THRESHOLD_MULTIPLIER = "0.8"
$env:TOURAB_WORKER_BUY_TREND_STRENGTH_MULTIPLIER = "1.35"
$env:TOURAB_WORKER_SELL_TREND_STRENGTH_MULTIPLIER = "1.1"
$env:TOURAB_WORKER_BUY_SHORT_MOVE_CONFIRMATION_BPS = "2"
$env:TOURAB_WORKER_SELL_SHORT_MOVE_CONFIRMATION_BPS = "0"
$env:TOURAB_WORKER_BUY_ENTRY_OFFSET_MULTIPLIER = "1.1"
$env:TOURAB_WORKER_SELL_ENTRY_OFFSET_MULTIPLIER = "0.5"
$env:TOURAB_WORKER_EXPECTED_MOVE_HURDLE_ENABLED = "1"
$env:TOURAB_WORKER_EXPECTED_MOVE_TP_R_MULTIPLE = "1.25"
...
$env:TOURAB_WORKER_MAX_PENDING_ENTRIES_PER_SYMBOL = "2"
$env:TOURAB_POLICY_AUTO_MAX_OPEN_TRADES_PER_SYMBOL = "1"
...
Invoke-RestMethod -Uri "http://localhost:7071/auto-exit/config" -Method Post -Headers $headers -ContentType "application/json" -Body '{"enabled":true,"maxHoldSec":600,"takeProfitRMultiple":1.25,"exitOffsetBps":1}' | Out-Null
...
$run = Start-Process -FilePath "npm.cmd" `
  -ArgumentList "exec", "--", "tsx", "scripts/policy-auto-progress-run.ts", "--label", "btc-policy-auto-30m-tight-exit", "--base-url", "http://localhost:7071", "--duration-sec", "1800", "--drain-sec", "300", "--poll-ms", "5000", "--progress-sec", "30" `
  -WorkingDirectory $root `
  -RedirectStandardOutput $runOut `
  -RedirectStandardError $runErr `
  -PassThru

$finishAt = (Get-Date).AddMinutes(30)
