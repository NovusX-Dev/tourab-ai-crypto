...
async function main(): Promise<void> {
  ...
  const env: NodeJS.ProcessEnv = {
    ...
    TOURAB_WORKER_SOL_ENTRY_OFFSET_BPS: "3",
    TOURAB_WORKER_SOL_STOP_DISTANCE_BPS: "28",
    TOURAB_WORKER_SOL_BLOCKED_UTC_HOURS: "99",
    TOURAB_AUTO_EXIT_SOL_MAX_HOLD_SEC: "90",
    TOURAB_AUTO_EXIT_SOL_TP_R_MULTIPLE: "0.45",
    TOURAB_AUTO_EXIT_SOL_OFFSET_BPS: "1",
    TOURAB_AUTO_EXIT_SOL_FORCE_FLATTEN_BPS: "4"
  };
