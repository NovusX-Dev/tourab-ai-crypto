...
## Non-goals
- request-signature math
- retry and rate-limit handling
- strategy or PnL evaluation
- generic rollout governance beyond environment separation
- replacing the adapter's detailed execution behavior
